...
public class RoRFrame extends JFrame {
	...
	public RoRFrame(UIController uiController, String title)
		...
		// Statistiques
		Font bFont = new Font(UIManager.getDefaults()
				.getFont("TabbedPane.font").getFontName(), Font.BOLD, UIManager
				.getDefaults().getFont("TabbedPane.font").getSize());
		Font h1Font = new Font(UIManager.getDefaults()
				.getFont("TabbedPane.font").getFontName(), Font.BOLD, UIManager
				.getDefaults().getFont("TabbedPane.font").getSize() + 2);
		...
		JLabel totalTimeOrderTitleLabel = new JLabel(
